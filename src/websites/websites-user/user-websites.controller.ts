...
import { UpdateTemplateCodeDto } from './dtos/update-template-code';
...
export class UserWebsitesController {
  ...
  changeTemplate(
    ...
    @Param('templateCode') dto: UpdateTemplateCodeDto,
  ) {
    return this.changeTemplateUseCase.execute(user.id!, dto.templateCode);
  }
